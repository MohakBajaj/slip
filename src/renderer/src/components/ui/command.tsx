...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        className={cn(
          "top-[18%] left-1/2 w-[calc(100%-1.5rem)] max-w-none -translate-x-1/2 translate-y-0 overflow-hidden rounded-xl p-0 shadow-lg",
          className
        )}
      ...
      >
        ...
        <Command className="max-h-[min(22rem,70vh)]">{children}</Command>
      </DialogContent>
    </Dialog>
  );
}
